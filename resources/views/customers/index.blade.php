...
<body>
    <nav>
        ...
        <div class="nav__btn">
            <a href="{{ route('admin.customers.create') }}" class="btn"><i class="ri-add-line"></i> Үйлчлүүлэгч нэмэх</a>
        </div>
    </nav>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid var(--extra-light); transition: all 0.3s;" onmouseover="this.style.backgroundColor='var(--extra-light)'" onmouseout="this.style.backgroundColor='white'">
                        ...
                        <td style="padding: 1rem; text-align: center;">
                            <a href="{{ route('admin.customers.edit', $customer->id) }}" class="btn" style="min-width: 80px; margin: 0 5px; font-size: 0.85rem; padding: 0.5rem 1rem; background-color: var(--primary-color);">
